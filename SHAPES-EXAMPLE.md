...
You will then have to select the relevan Approov SDK version you wish to use. To do so, select the `Exact Version` option and enter the relevant SDK version, in this case we will use the `2.9.0` Approov SDK:
